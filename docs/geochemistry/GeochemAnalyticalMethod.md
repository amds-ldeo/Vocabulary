...
- [Analytical method](#analyticalmethod)
    ...
    - [Imaging techniques](#imagingtechniques)
        ...
        - [Advanced Imaging & Visualization of Astromaterials](#aiva)
        ...
        - [Particle spectrometry](#particlespectrometry)
            ...
            - [Mass spectrometry](#massspectrometry)
                ...
                - [Secondary ionization mass spectrometry](#secondaryionizationmassspectrometry)
                    - [Sensitive high-mass-resolution ion microprobe](#shrimp)
...
- Child of:
 [`imagingtechniques`](#imagingtechniques)
- Technique developed at the NASA Johnson Space Center to manually
photograph spacecraft flight hardware and astromaterial samples inside
a custom nitrogen-filled glovebox in a cleanroom facility, while the
lighting and camera equipment are outside the glovebox.  Imagery is
created using  high-resolution precision photography methods,
developed for work in cleanroom environments, with the addition of a
semi-automated focus stacking procedure, where each final image
product is assembled from an average of 87 individual photographs of
the same scene. The focus stacking blends the best in-focus areas from
a sequence of image frames to create a final product with little to no
blur from lack of depth of field. The set of image frames is captured
at micro increments between focus settings at the nearest and farthest
sides of the scene.
- **Source:**
<https://w3id.org/geochem/1.0/agent/orex>, 
<https://www.hou.usra.edu/meetings/lpsc2025/pdf/1617.pdf>, 
- Concept URI: https://w3id.org/geochem/1.0/analyticalmethod/aiva
...
for inlet into mass analyzer. Components 1) sample prepartion:
...
https://w3id.org/geochem/1.0/agent/orex, 
https://w3id.org/geochem/1.0/agent/petdb, 
- Concept URI: https://w3id.org/geochem/1.0/analyticalmethod/laserablationinductivelycoupledplasmamassspectrometry
